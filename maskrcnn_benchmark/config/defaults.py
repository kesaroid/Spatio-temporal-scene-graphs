...
_C.MODEL.ROI_HEADS.NMS_FILTER_DUPLICATES = True 
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 37
...
_C.MODEL.ROI_ATTRIBUTE_HEAD.NUM_ATTRIBUTES = 1
_C.MODEL.ROI_ATTRIBUTE_HEAD.MAX_ATTRIBUTES = 1  # max number of attribute per bbox
...
_C.MODEL.ROI_RELATION_HEAD.NUM_CLASSES = 27
...
_C.MODEL.ROI_RELATION_HEAD.REL_PROP =   [0.21814, 0.03431, 0.09275, 0.04484, 0.17107, 0.03519, 
                                        0.12795, 0.137, 0.01735, 0.03997, 0.03861, 0.00537,                                        
                                        6e-05, 0.01122, 0.00668, 0.00394, 0.00029, 0.00056, 
                                        0.00344, 0.00084, 0.00289, 0.00317, 0.00261, 0.00137, 0.00025, 0.00012]
...
_C.SOLVER.IMS_PER_BATCH = 16        #TODO Experiment
...
_C.TEST.RELATION = CN()
_C.TEST.RELATION.MULTIPLE_PREDS = True
