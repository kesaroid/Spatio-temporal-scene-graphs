...
class QA:
    ...
    def create_questions(self):
        ...
        for obj in self.objs:
            ...
            #         for edge in self.G.edges(rel):
            #             range_q2 = f"Which other object was the Person interacting with while {rel} the {obj}"
            #             self.all_questions['range'].append(range_q2)
            ...
            # self.all_questions['temporal'].extend([temporal_q1, temporal_q2]) 
            repeat_q2 = f"How many times did the Person interact with {obj}?"
            appendo(repeat_q2, "repeat", [repeat_q2, obj, None])
            repeat_q3 = f"How many times did the Person looking_at the {obj}?"
            appendo(repeat_q3, "repeat", [repeat_q3, obj, 'looking_at'])
